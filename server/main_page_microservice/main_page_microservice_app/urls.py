...
urlpatterns = [
    ...
    path('news/create/', create_news_article, name='create_news_article'),
    path('news/<int:article_id>/update/', update_news_article, name='update_news_article'),
    path('news/<int:article_id>/delete/', delete_news_article, name='delete_news_article'),
]
