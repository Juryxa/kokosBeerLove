...
class Match(models.Model):
    ...
    team_away_name = models.CharField(max_length=500)  # Название гостевой команды
    team_away_logo_url = models.URLField(max_length=1000, blank=True, null=True)  # URL логотипа гостевой команды
    ...
    def __str__(self):
        return f"{self.team_home} vs {self.team_away_name} on {self.match_date} at {self.match_time}"
