...
from .views.heandlers_match.create_away_team import create_team
from .views.heandlers_match.update_about_fc_kokoc import update_about_fc_kokoc
from .views.heandlers_match.get_about_fc_kokoc import get_about_fc_kokoc

urlpatterns = [
    path('get_all/', get_all_matches, name='get_all_matches'),
    path('create_away_team/', create_team, name='create_team'),
