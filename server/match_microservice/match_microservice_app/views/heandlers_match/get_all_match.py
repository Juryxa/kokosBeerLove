...
@swagger_auto_schema(method="get",
                     ...
                     responses={200: openapi.Response(description="Успешный ответ с данными всех матчей",
...
def get_all_matches(request):
    # Получаем все матчи, отсортированные по дате и времени (сначала
    # предстоящие, затем прошедшие)
