...
@swagger_auto_schema(method="get",
                     ...
                     manual_parameters=[openapi.Parameter("cur_cnt_video",
                                                          openapi.IN_QUERY,
                                                          description="Текущее количество открытых видео",
                                                          type=openapi.TYPE_INTEGER,
                                                          )],
                     responses={200: openapi.Response(description="Успешный ответ с данными матчей",
...
def get_next_matches(request):
    ...
    next_matches = Match.objects.all().order_by("match_date", "match_time")[
        cur_cnt_video: cur_cnt_video + 4
    ]
