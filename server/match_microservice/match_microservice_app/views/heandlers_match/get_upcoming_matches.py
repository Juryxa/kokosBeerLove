...
@swagger_auto_schema(method="get",
                     ...
                     responses={200: openapi.Response(description="Успешный ответ с данными предстоящих матчей",
...
def get_upcoming_matches(request):
    ...
    upcoming_matches = (
        Match.objects.filter(match_date__gte=now.date())
        .exclude(match_date=now.date(), match_time__lte=now.time())
