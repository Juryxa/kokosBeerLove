...
@swagger_auto_schema(
    method='put',
    operation_description="Редактирование информации о клубе. Доступно только администраторам (is_superuser == true).",
    ...
    responses={
        ...
        403: openapi.Response(description="У вас нет прав доступа для изменения информации (нужен is_superuser)."),
