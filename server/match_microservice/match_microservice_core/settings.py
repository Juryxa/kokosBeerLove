...
DATABASES = {
    'default': {
        ...
        'NAME': config('DATABASE_NAME_MATCH'),
        'USER': config('DATABASE_USER_MATCH'),
        'PASSWORD': config('DATABASE_PASSWORD_MATCH'),
        'HOST': config('DATABASE_HOST_MATCH'),
        'PORT': config('DATABASE_PORT_MATCH'),
    }
}
